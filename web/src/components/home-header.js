...
const HomeHeader = ({ pageDescription }) => {
    ...
    return (
        <section className={'flex gap-2 sm:h-screen sm:-mt-32 mb-6 pt-10 md:pt-32'} style={{ maxHeight: '872px' }}>
            ...
            <div className={'hidden sm:flex sm:w-1/3 md:w-1/2 bg-indigo-500 justify-between rounded-2xl overflow-hidden relative'}>
                <div className={'w-full flex flex-col gap-6 justify-center'} style={{ backgroundPosition: 'center', backgroundImage: `url(${main_image.localFile.publicURL})`, maxHeight: '841px' }}>
                </div>
            </div>
        </section>
    )
